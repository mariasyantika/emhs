                ...
                <div class="dropdown float-right">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item" href="#">
                        <div class="media">
                            <img class="align-self-center mr-3" src="https://i.pinimg.com/564x/b9/17/ff/b917ff1ad932fb0838757f2e0cd874cc.jpg" alt="Generic placeholder image" height="50" width="50">
                            <div class="media-body">
                              <h5 class="mt-2">{{ Auth::user()->name ?? '' }}</h5>
                              <small><i class="bi bi-emoji-smile"></i> Morning, {{ Auth::user()->name ?? '' }}</small>
                            </div>
                          </div>
                      </a>
